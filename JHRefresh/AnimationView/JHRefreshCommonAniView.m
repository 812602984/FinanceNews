...
NSString *const JHRefreshHeaderStatusTextPulling = @"松开即可刷新 ^_^";
...
NSString *const JHRefreshFooterStatusTextPulling = @"松开即可加载 ^_^";
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _lastUpdateTimeLabel.textColor = [UIColor whiteColor];
        _lastUpdateTimeLabel.backgroundColor = [UIColor blackColor];
