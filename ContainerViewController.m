...
- (Topbar *)topbar {
    if (!_topbar) {
        _topbar = [[Topbar alloc] initWithFrame:CGRectMake(0, [[UIApplication sharedApplication] statusBarFrame].size.height+30, CGRectGetWidth(self.view.frame), kTopbarHeight)];
        _topbar.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"scrollbg.png"]];
